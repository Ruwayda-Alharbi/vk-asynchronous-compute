                                            ...
                                            uint32_t                     subpass)
{
  ...
  attribute_desc[0].offset                            = IM_OFFSETOF(ImDrawVert, position);
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
  ...
  wd->SurfaceFormat =
      ImGui_ImplVulkanH_SelectSurfaceFormat(v->PhysicalDevice, wd->Surface, requestSurfaceImageFormat,
  ...
  wd->PresentMode =
      ImGui_ImplVulkanH_SelectPresentMode(v->PhysicalDevice, wd->Surface, &present_modes[0], IM_ARRAYSIZE(present_modes));
...
static void ImGui_ImplVulkan_SetWindowSize(ImGuiViewport* viewport, ImVec2 size)
{
  ...
  ImGui_ImplVulkanH_CreateOrResizeWindow(v->Instance, v->PhysicalDevice, v->Device, &data->Window, v->QueueFamily,
