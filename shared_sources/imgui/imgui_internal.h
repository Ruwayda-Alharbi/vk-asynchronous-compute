...
namespace ImGui
{
    ...
    IMGUI_API void          DockBuilderSetNodePos(ImGuiID node_id, ImVec2 position);
    ...
    IMGUI_API void          RenderMouseCursor(ImDrawList* draw_list, ImVec2 position, float scale, ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow);
    ...
    IMGUI_API bool          CollapseButton(ImGuiID id, const ImVec2& position, ImGuiDockNode* dock_node);
